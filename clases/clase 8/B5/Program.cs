...
// Clase que representa un elemento con Id y Total
...
public class NodoArbolB
{
    ...
    public List<Elemento> Claves { get; set; }
...
public class ArbolB
{
    ...
    private void InsertarNoLleno(NodoArbolB nodo, Elemento elemento)
    {
    ...
    public List<Elemento> RecorridoInOrden()
    {
    ...
    private void RecorridoInOrdenRecursivo(NodoArbolB nodo, List<Elemento> resultado)
    {
        if (nodo == null)
            return;
